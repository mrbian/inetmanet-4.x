...
#include "inet/routing/extras/LoadNg/LoadNgBase.h"
...
void LoadNgBase::actualizeCostUsingStatus(const NodeStatus *status, LoadNgRouteData * loadNgRouteData) {
...
void LoadNgBase::actualizeCostUsingNeig(const NeigborElement *status, LoadNgRouteData * loadNgRouteData) {
    loadNgRouteData->setEnergy(status->energy);
