...
// Copyright (C) 2020 Universidad de Malaga
...
#ifndef __INET_LOADNG_CT_H
#define __INET_LOADNG_CT_H
...
class INET_API LoadNgCt: public RoutingProtocolBase, public NetfilterBase::HookBase, public cListener
{
  protected:
...
//end unidirectional structs
    ...
    // LoadNg parameters: the following parameters are configurable, see the NED file for more info.
    ...
    simtime_t minHelloJitter;
    simtime_t maxHelloJitter;
  ...
  protected:
    ...
    void sendRREP(const Ptr<Rrep>& rrep, const L3Address& destAddr, unsigned int timeToLive, const double &cost, const double &delay = -1);
