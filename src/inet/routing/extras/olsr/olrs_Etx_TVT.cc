...
bool
Olsr_Etx_TVT::populate_nbset(OlsrMsg& msg)
{
    ...
    if (nb_tuple != nullptr)
        ...
        nb_tuple->mob_info_idx_ = hello.node_mob_info_;
    return false;
}
...
Olsr_Etx_TVT::predict_link_expire_time(int node_mob_info)
{
    ...
    emit(linkExpireTimeSignal, link_expire_time);
...
Olsr_Etx_TVT::olsr_mpr_computation_TVT()
{
    ...
    for (auto it = nbset().begin(); it != nbset().end(); it++)
    {
        ...
        {
            OLSR_ETX_nb_tuple *nb_tuple = *it;
            double let = predict_link_expire_time(nb_tuple->mob_info_idx_);
            if(let > 0)
            {
                nb_tuple->let = let;
                N.push_back(*it);
    ...
    while (N2.begin() != N2.end())
    {
        ...
        for (auto it = rs.begin(); it != rs.end(); it++)
        {
                    ...
                    it2 != reachability[r].end(); it2++)
            {
                ...
                {
                    if(nb_tuple->let > max->let)
                    {
                        max = nb_tuple;
                        max_r = r;
                    }
                    else if(nb_tuple->let == max->let)
                    {
                        if (r > max_r)
                        {
                            max = nb_tuple;
...
//        OLSR_ETX_nb_tuple* min = nullptr;
//        double min_improved_etx = 100;
//        int max_r = 0;
//        for (auto it = rs.begin(); it != rs.end(); it++)
//        {
//            int r = *it;
...
//            {
//                OLSR_ETX_nb_tuple *nb_tuple = *it2;
//                Olsr_Etx_link_tuple *nb_link_tuple = nullptr, *min_link_tuple = nullptr;
...
//                    {
//                        min = nb_tuple;
//                        min_improved_etx = nb_link_tuple->improved_ext(now);
//                        max_r = r;
//                    }
//                    continue;
//                }
//                link_tuple_aux = state_.find_sym_link_tuple(min->nb_main_addr(), now);
//                if (link_tuple_aux)
//                {
//                    min_link_tuple = dynamic_cast<Olsr_Etx_link_tuple *>(link_tuple_aux);
//                    if (!min_link_tuple)
//                        throw cRuntimeError("\n Error conversion link tuple");
//                }
//                if (nb_link_tuple == nullptr)
//                    continue;
//                else if (nb_link_tuple != nullptr && min_link_tuple == nullptr)
//                {
//                    min = nb_tuple;
//                    min_improved_etx = nb_link_tuple->improved_ext(now);
//                    max_r = r;
//                    continue;
//                }
//                if (nb_link_tuple->improved_ext(now) < min_link_tuple->improved_ext(now)) // if equal, use last because reachability is max
//                {
//                    min = nb_tuple;
//                    min_improved_etx = nb_link_tuple->improved_ext(now);
//                    max_r = r;
//                }
//                else if(nb_link_tuple->improved_ext(now) == min_link_tuple->improved_ext(now))
//                {
//                    if (r > max_r)
//                    {
//                        min = nb_tuple;
...
//        if (min != nullptr)
//        {
//            state_.insert_mpr_addr(min->nb_main_addr());
//            CoverTwoHopNeighbors(min->nb_main_addr(), N2);
//            EV_DETAIL << N2.size () << " 2-hop neighbors left to cover! \n";
//        }
    }
}
