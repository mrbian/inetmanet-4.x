...
Define_Module(StateBasedEpEnergyConsumerLevel);

void StateBasedEpEnergyConsumerLevel::initialize(int stage)
{
...
void StateBasedEpEnergyConsumerLevel::receiveSignal(cComponent *source, simsignal_t signal, intval_t value, cObject *details)
{
...
W StateBasedEpEnergyConsumerLevel::computePowerConsumption() const
{
