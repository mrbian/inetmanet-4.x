...
#ifndef __INET_STATEBASEDEPENERGYCONSUMERLEVEL_H
#define __INET_STATEBASEDEPENERGYCONSUMERLEVEL_H
 ...
 *
 */
class INET_API StateBasedEpEnergyConsumerLevel : public cSimpleModule, public power::IEpEnergyConsumer, public cListener
{
  protected:
    // parameters
  ...
  public:
    virtual void setTransmissionConsumption(W p) {transmitterTransmittingPowerConsumption = p;}
