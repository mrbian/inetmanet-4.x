...
Define_Module(StateBasedCcEnergyConsumerLevel);

void StateBasedCcEnergyConsumerLevel::initialize(int stage)
{
...
void StateBasedCcEnergyConsumerLevel::receiveSignal(cComponent *source, simsignal_t signal, intval_t value, cObject *details)
{
...
void StateBasedCcEnergyConsumerLevel::receiveSignal(cComponent *source, simsignal_t signal, double value, cObject *details)
{
    Enter_Method("%s", cComponent::getSignalName(signal));
...
A StateBasedCcEnergyConsumerLevel::computeCurrentConsumption() const
{
