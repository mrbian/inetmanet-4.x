...
#ifndef __INET_STATEBASEDCCENERGYCONSUMERLEVEL_H
#define __INET_STATEBASEDCCENERGYCONSUMERLEVEL_H
 ...
 *
 */
class INET_API StateBasedCcEnergyConsumerLevel : public cSimpleModule, public virtual power::ICcEnergyConsumer, public cListener
{
  protected:
    // parameters
  ...
  public:
    virtual void setTransmissionConsumption(A i) {transmitterTransmittingCurrentConsumption = i;}
