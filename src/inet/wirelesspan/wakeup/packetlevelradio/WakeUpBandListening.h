...
class INET_API WakeUpBandListening : public BandListening
{
  ...
  public:
    WakeUpBandListening(const IRadio *radio, simtime_t startTime, simtime_t endTime, Coord startPosition, Coord endPosition, Hz centerFrequency, Hz bandwidth, std::vector<FreqItem> b);
